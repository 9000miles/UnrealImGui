...
{
public:
	static TSharedRef<FImGuiTextInputMethodContext> Create(const TSharedRef<SImGuiWidget>& Widget);
	void CacheWindow();
...
private:
	FImGuiTextInputMethodContext(const TSharedRef<SImGuiWidget>& Widget);
	TWeakPtr<SImGuiWidget> OwnerWidget;
